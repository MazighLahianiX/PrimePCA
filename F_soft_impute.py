'''
   Soft impute implementation from the Fancyinput library 

   Added small modifications and a warm starts option.  
'''
...
from fancyimpute.common import masked_mae
...
class SoftImpute(Solver):
    ...
    def solve(self, X, missing_mask, warm_start=None):
        X = X.copy()
        ...
        if(warm_start is None): 
            ...
            X_filled[missing_mask] = warm_start[missing_mask]
